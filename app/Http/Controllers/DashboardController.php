...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $saw = Saw::where('nip', Auth::user()->nip)->get();
        ...
        $idd = date('dmy') . Auth::user()->nip;

        $abseninout = In::join('outs', 'ins.id', '=', 'outs.id')
            ->select('ins.id', 'ins.time as time_in', 'ins.gambar as gambar_in', 'outs.time as time_out', 'outs.gambar as gambar_out')
            ->where('ins.id', $idd)
            ->get();
        ...
        $penilaian = Penilaian::where('nip', Auth::user()->nip)->get();
